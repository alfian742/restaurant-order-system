            ...
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto text-center">
                        ...
                        <?php if (isset($_SESSION['email']) && isset($_SESSION['level']) && $_SESSION['level'] === 'Admin'): ?>
                            <a href="<?= base_url('admin/index.php'); ?>" class="nav-item nav-link">Dashboard</a>
                        <?php endif ?>
                    </div>
                    <div class="d-flex justify-content-center gap-2 m-3 me-xl-0 text-center">
                        <?php if (isset($_SESSION['email']) && isset($_SESSION['level'])): ?>
                            <a href="<?= base_url('user/cart.php'); ?>" class="position-relative my-auto">
                                ...
                                <?php
                                $sql_jumlah_item = "SELECT * FROM keranjang WHERE id_user='{$_SESSION['id_user']}' AND status='Belum Dipesan'";
                            ...
                            <div class="nav-item dropdown my-auto">
                                ...
                                <div class="dropdown-menu dropdown-menu-end m-0 bg-secondary rounded-0">
                                    <a href="<?= base_url('user/profile.php'); ?>" class="dropdown-item text-dark <?= ($title === 'Profil') ? 'bg-secondary' : ''; ?>">
                                        <i class="dropdown-icons fa fa-user me-2"></i>
                                        Profil</a>
                                    <a href="<?= base_url('user/order.php'); ?>" class="dropdown-item text-dark <?= ($title === 'Riwayat Pesanan') ? 'bg-secondary' : ''; ?>">
                                        <i class=" dropdown-icons fa fa-history me-2"></i> Riwayat
                                        Pesanan</a>
                                    <a href="#" class="dropdown-item text-dark" data-bs-toggle="modal" data-bs-target="#logoutModal"><i
                                            class="dropdown-icons fa fa-sign-out-alt me-2"></i> Keluar</a>
                                </div>
                            </div>
                        <?php else: ?>
        ...
        <div class="container py-4">
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-6 text-center">
                    <span class="text-light"><i class="fas fa-copyright"></i> <?= date('Y'); ?> Pan & Co. Hak cipta dilindungi.</span>
                </div>
        ...
        <div class="modal fade" id="menuModal" tabindex="-1" aria-labelledby="menuModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body">
                        Silahkan "Masuk" untuk menambahkan menu ke keranjang.
                    </div>
                    <div class="modal-footer border-0">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Tutup</button>
