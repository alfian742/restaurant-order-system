...
if (isset($_POST['add-menu'])) {
    ...
    if (empty($nama_menu)) {
        ...
        if (mysqli_num_rows($cek_nama_menu) > 0) {
            $errors['nama_menu'] = 'Nama menu sudah ada, silahkan gunakan nama lain.';
        } else {
    ...
    if (empty($errors)) {
        ...
        echo "<script>window.location.href = '" . base_url('admin/menu/create.php') . "';</script>";
        exit();
    }
}
    ...
    if (empty($errors)) {
        ...
        if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] == 0) {
            ...
            if ($upload) {
                ...
                echo "<script>window.location.href = '" . base_url('admin/menu/edit.php?menu-id=' . $id_menu) . "';</script>";
                exit();
            }
        }
