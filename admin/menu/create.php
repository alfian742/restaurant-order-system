...
<div class="pagetitle">
    <div class="d-flex justify-content-start align-items-center gap-2 mb-4">
        <a href="<?= base_url('admin/menu/show.php'); ?>" class="btn btn-outline-secondary rounded-circle border-0 btn-back"><i class="bi bi-arrow-left"></i></a>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body pt-4">
                    ...
                    $nama_menu = isset($_SESSION['form_data']['nama_menu']) ? htmlspecialchars($_SESSION['form_data']['nama_menu']) : '';
                    $harga = isset($_SESSION['form_data']['harga']) ? htmlspecialchars($_SESSION['form_data']['harga']) : '';
                    $kategori = isset($_SESSION['form_data']['kategori']) ? htmlspecialchars($_SESSION['form_data']['kategori']) : '';
                    $status = isset($_SESSION['form_data']['status']) ? htmlspecialchars($_SESSION['form_data']['status']) : '';
                    $deskripsi = isset($_SESSION['form_data']['deskripsi']) ? htmlspecialchars($_SESSION['form_data']['deskripsi']) : '';
                    ?>

                    <form method="post" action="<?= base_url('admin/menu/action.php'); ?>" enctype="multipart/form-data">
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-md-4">
                                <label for="gambar" class="form-label d-flex justify-content-center">
                                    <img id="preview-img" src="<?= get_image_url(base_url('assets/uploads/static/image-placeholder.jpg')); ?>" alt="Pratinjau Gambar" class="rounded object-fit-cover cursor-pointer img-preview" height="250" width="250">
                                </label>
                        ...
                        <button type="submit" name="add-menu" class="btn btn-primary text-white px-3">Simpan</button>
                    </form>
