...
if (!mysqli_num_rows($query_menu) > 0) {
    ...
    echo "<script>window.location.href = '" . base_url('admin/menu/show.php') . "';</script>";
    exit();
} else {
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body pt-4">
                    ...
                    <form method="post" action="<?= base_url('admin/menu/action.php?update-menu=' . $id_menu); ?>" enctype="multipart/form-data">
