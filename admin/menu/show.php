            ...
            <div class="card">
                <div class="card-body pt-4">
                    ...
                    <div class="d-flex justify-content-end mb-4">
                        <a href="<?= base_url('admin/menu/create.php'); ?>" class="btn btn-sm btn-primary">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $data['kategori'] ?></td>
                                    <td>
                                        <form method="post" action="<?= base_url('admin/menu/action.php?update-menu-status=' . $data['id_menu'] . '&current-category=All'); ?>">
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <!-- Edit button -->
                                            <a href="<?= base_url('admin/menu/edit.php?menu-id=' . $data['id_menu']); ?>" class="btn btn-sm btn-primary">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0">
                                                    ...
                                                    <div class="modal-footer border-0">
                                                        ...
                                                        <a href="<?= base_url('admin/menu/action.php?delete-menu=' . $data['id_menu']); ?>" class="btn btn-danger text-white px-4">Ya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
