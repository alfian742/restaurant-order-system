...
<section class="section dashboard">
  <div class="row">
    ...
    $sql_today = "SELECT COUNT(*) as count FROM pesanan WHERE DATE(tanggal) = CURDATE()";
    ...
    $sql_this_month = "SELECT COUNT(*) as count FROM pesanan WHERE MONTH(tanggal) = MONTH(CURDATE()) AND YEAR(tanggal) = YEAR(CURDATE())";
    ...
    $sql_revenue_today = "SELECT SUM(total_pembayaran) as revenue FROM pesanan WHERE DATE(tanggal) = CURDATE() AND status='Completed'";
    ...
    $sql_revenue_this_month = "SELECT SUM(total_pembayaran) as revenue FROM pesanan WHERE MONTH(tanggal) = MONTH(CURDATE()) AND YEAR(tanggal) = YEAR(CURDATE()) AND status='Completed'";
    ...
    <div class="col-12">
      <div class="row">
        ...
        <div class="col-lg-9">
          <?php
          // Inisialisasi array untuk jumlah pesanan dan pendapatan
          $daily_orders = array_fill(0, 31, 0); // Array untuk 31 hari
          $daily_revenue = array_fill(0, 31, 0); // Array untuk 31 hari
          ...
          $sql_daily_data = "SELECT DAY(tanggal) as day, COUNT(*) as orders, SUM(total_pembayaran) as revenue 
                             FROM pesanan 
                             WHERE MONTH(tanggal) = '$current_month' AND YEAR(tanggal) = '$current_year' AND status='Completed' 
                             GROUP BY day";
