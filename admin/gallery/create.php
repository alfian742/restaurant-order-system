...
<div class="pagetitle">
    <div class="d-flex justify-content-start align-items-center gap-2 mb-4">
        <a href="<?= base_url('admin/gallery/show.php'); ?>" class="btn btn-outline-secondary rounded-circle border-0 btn-back"><i class="bi bi-arrow-left"></i></a>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body pt-4">
                    ...
                    $keterangan = isset($_SESSION['form_data']['keterangan']) ? htmlspecialchars($_SESSION['form_data']['keterangan']) : '';
                    ?>

                    <form method="post" action="<?= base_url('admin/gallery/action.php'); ?>" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="add-gallery" class="btn btn-primary text-white px-3">Simpan</button>
                    </form>
