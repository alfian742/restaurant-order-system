...
if (isset($_POST['add-gallery'])) {
    ...
    if (empty($errors)) {
        ...
        echo "<script>window.location.href = '" . base_url('admin/gallery/create.php') . "';</script>";
        exit();
    }
}
    ...
    if (empty($errors)) {
        ...
        if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] == 0) {
            ...
            if ($upload) {
                ...
                echo "<script>window.location.href = '" . base_url('admin/gallery/edit.php?gallery-id=' . $id_galeri) . "';</script>";
                exit();
            }
        }
