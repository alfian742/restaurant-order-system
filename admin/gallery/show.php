            ...
            <div class="card">
                <div class="card-body pt-4">
                    ...
                    <div class="d-flex justify-content-end mb-4">
                        <a href="<?= base_url('admin/gallery/create.php'); ?>" class="btn btn-sm btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <!-- Edit button -->
                                            <a href="<?= base_url('admin/gallery/edit.php?gallery-id=' . $data['id_galeri']); ?>" class="btn btn-sm btn-primary">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0">
                                                    ...
                                                    <div class="modal-footer border-0">
                                                        ...
                                                        <a href="<?= base_url('admin/gallery/action.php?delete-gallery=' . $data['id_galeri']); ?>" class="btn btn-danger text-white px-4">Ya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
