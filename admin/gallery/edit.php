...
if (!mysqli_num_rows($query_galeri) > 0) {
    ...
    echo "<script>window.location.href = '" . base_url('admin/gallery/show.php') . "';</script>";
    exit();
} else {
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body pt-4">
                    ...
                    <form method="post" action="<?= base_url('admin/gallery/action.php?update-gallery=' . $id_galeri); ?>" enctype="multipart/form-data">
