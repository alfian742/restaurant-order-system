...
<div class="pagetitle">
    <div class="d-flex justify-content-between align-items-center gap-2 mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?= base_url('admin/manage-user/show.php'); ?>" class="btn btn-sm px-lg-3 btn-dark">Semua</a>
            ...
            ?>
                <a href="<?= base_url('admin/manage-user/role.php?role=' . urlencode($data_role_user['level'])); ?>" class="btn btn-sm px-lg-3 btn-light border-secondary">
