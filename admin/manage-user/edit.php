...
if (!mysqli_num_rows($query_user) > 0) {
    ...
    echo "<script>window.location.href = '" . base_url('admin/manage-user/show.php') . "';</script>";
    exit();
} else {
            ...
            <div class="card">
                <div class="card-body pt-4">
                    <div class="d-flex align-items-center gap-2 mb-4">
                        <a href="<?= base_url('admin/manage-user/role.php?role=Admin'); ?>" class="btn btn-outline-secondary rounded-circle border-0 btn-back"><i class="bi bi-arrow-left"></i></a>
                    ...
                    <form method="post" action="<?= base_url('admin/manage-user/action.php?update-user=' . $id_user); ?>">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <small><?= 'Role: ' . (($data_user['level'] === 'User') ? 'Pelanggan' : 'Admin'); ?></small>
                        </div>
                    </form>
